...
MODEL_PATHS = [
	"/home/lcb/github.com/LCB_MPC/SeniorDesignProject/build/mpc_model.npz"
]
...
R_USE   = np.array([0.01]*10, dtype=float)              # per-channel magnitude weight
LAMBDA_LINEAR = 0.0                                     # usually 0 if using R
"""
# --- Constraints ---
U_MIN = np.zeros(10, dtype=float)
U_MAX = np.full(10, 255.0, dtype=float)
DU_MAX = 128.0                                           # codes per frame (anti-flicker)
"""
U_MIN = 10
U_MAX = 255
DU_MAX = 128.0                                           # codes per frame (anti-flicker)
